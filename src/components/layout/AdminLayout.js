...
export default function AdminLayout({ children, title = 'Admin Dashboard' }) {
  ...
  const platformNavigation = [
    ...
    { name: 'Reports', href: '/admin/platform/reports', icon: BarChart3, current: router.pathname.startsWith('/admin/platform/reports') },
  ...
  const organizationNavigation = [
    ...
    { name: 'Courses', href: '/admin/organization/courses', icon: FileText, current: router.pathname.startsWith('/admin/organization/courses') },
    { name: 'Surveys', href: '/admin/organization/surveys', icon: FileText, current: router.pathname.startsWith('/admin/organization/surveys') },
    ...
    { name: 'Reports', href: '/admin/organization/reports', icon: BarChart3, current: router.pathname.startsWith('/admin/organization/reports') },
